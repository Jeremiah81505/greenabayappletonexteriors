        ...
        var PremiumAdvCarouselHandler = function ($scope, $) {
            ...
            if ('infinite' === animationType) {
                ...
                var $mediaItemsContainer = $outerContainer.find('.premium-adv-carousel__items'),
                    itemLen = $mediaItemsContainer.children().length; // initial length.
                ...
                var containerHeight = $scope.find('.premium-adv-carousel__inner-container').innerHeight(),
                    containerWidth = $scope.find('.premium-adv-carousel__inner-container').innerWidth(),
                ...
                var start = 'transform: translateY(' + containerHeight + 'px)',
                    end = 'transform: translateY(-101%)';

                if ('horizontal' === direction) {
                    start = "transform: translateX(" + containerWidth + "px)";
                ...
                if (settings.scroll || settings.pauseOnHover) {
                    ...
                    $outerContainer.on('mouseleave.paMediaWheel', function () {
