...
- Added: New Extension | Image Masking with Morphing
- Fixed: EA Woo Product Slider | Missing image resolution option in Preset 2 Layout
- Fixed: EA Content Timeline | Content ordering issues while date position is inside
- Improved: EA Smart Post List | Top Bar orientation selectable by device device
- Few minor bug fixes & improvements


= 6.6.2 - 08/10/2025 =

- Fixed: EA Widgets | Not rendering in Elementor preview mode
- Fixed: EA Content Timeline | Fatal error when ACF is not activated
- Fixed: EA Logo Carousel | Resize violation and slowness on iPhone
- Fixed: EA Advanced Tabs | Google Maps not displaying in saved templates
- Fixed: Elementor Tabs | Preview conflict when EA is activated
- Improved: EA Toggle | Added Liquid Glass Effect
- Improved: EA Advanced Search | Added support for variation SKUs
- Improved: EA Advanced Search | Current page number now visible in search results
- Improved: EA Advanced Menu | Style tab refinements
- Improved: Conditional Display | Woo Order Status and OS-based condition support
- Improved: EA Image Comparison | Implemented toggle (on/off)
- Improved: EA Advanced Search | Multisite search support added
- Improved: EA Lightbox & Modal | Added trigger by text support
- Improved: EA Protected Content | Tabs reset to first after unlocking
- Improved: EA Dynamic Gallery | Added option to show filters on the left side
- Few minor bug fixes & improvements

= 6.6.1 - 18/09/2025 =
- Fixed: EA Image Hotspots | Custom SVG icons not displaying
- Fixed: EA Interactive Animation | Marker placement issue
- Fixed: EA Content Timeline | Bold styling not working
- Fixed: EA Login/Register Form | Google login redirection issue
- Fixed: EA Advanced Search | Category exclusion not working
- Improved: EA Dynamic Gallery | Limit ACF images
- Improved: EA Testimonial Slider | New layout added
- Improved: EA Post Carousel | Disabled image links still output HTML tags
- Improved: EA Advanced Menu | Style tab improvements
- Improved: EA Code Snippet | Usability enhancement
- Few minor bug fixes & improvements

= 6.6.0 - 01/09/2025 =
- Added: New Extension | EA Custom Cursor
- Few minor bug fixes & improvements

= 6.5.0 - 24/08/2025 =
- Added: New Extension | Liquid Glass Effects
- Fixed: EA Smart Post List | Filtering not working and throwing 500 server error
- Few minor bug fixes & improvements

= 6.4.3 - 13/08/2025 =

- Fixed: EA Protected Content | PHP error
- Fixed: EA Smart Post List | Deprecated strtolower() warning
- Fixed: EA Logo Carousel | Responsive logo count issue
- Fixed: EA Woo Account Dashboard | Address layout broken
- Fixed: EA Filterable Gallery | Harmonic layout after filter
- Fixed: EA Login/Register | TutorLMS Pro social login issue
- Fixed: EA Interactive Card | PHP warning (stream open error)
- Fixed: EA Content Timeline | Bullet styling not applying
- Fixed: EA Slider & Carousel | Accessibility issues
- Improved: EA Advanced Data Table | Exclude blank Google Sheet rows
- Improved: EA Smart Post List | Show "Last modified date" as meta
